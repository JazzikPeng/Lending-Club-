...
@FileName: DeepLearning_Model_V9
...
def create_model(dropout_rate=0.0, init_mode = 'normal', learn_rate = 0.00001):
...
model_dnn = load_model('binary_classification_V9.h5')
print('Finished Loading, Continue Training Model V9')
model_dnn.fit(X_train, Y_train, epochs=1000, batch_size=1024, verbose = 2)
model_dnn.save('binary_classification_V9.h5')
